...
- **V1 (current)** — Windows Server 2022 / 2025. Pre-hardened marketplace images with 300+ technical security controls; audit, apply, snapshot, rollback, branded reporting, verify, and drift monitoring with Graph/SMTP alerts; framework-alignment mapping across recognised standards; **Authenticode code signing (InfraSOS FZCO) with a signed SHA-256 integrity manifest** (see [Architecture › Software integrity and trust](architecture.md)).
